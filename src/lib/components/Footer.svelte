  ...
  <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
       ...
       <div class="flex flex-col items-center md:items-start text-center md:text-left space-y-4">
        ...
        <p class="text-sm text-surface-400 font-mono max-w-xs mx-auto md:mx-0">
          {'>'} Se stai leggendo questo, grazie per l'attenzione non esitare a contattarmi {'<3'}
        </p>
      </div>
     
      <div class="text-center space-y-4">
        <h4 class="text-sm font-bold text-surface-400 font-mono uppercase tracking-wider mb-4">
          Quick Links
        </h4>
        <div class="flex flex-col gap-3">
          <a 
            href="/#about-me" 
            class="group inline-flex items-center justify-center gap-2 text-surface-300 hover:text-primary-400 transition-colors font-mono text-sm"
          >
            <Icon icon="mdi:chevron-right" width="16" class="group-hover:translate-x-1 transition-transform" />
            <span>About Me</span>
          </a>
          <a 
            href="/#my-work" 
    ...
    <div class="flex flex-col sm:flex-row justify-between items-center gap-4 text-sm">
      ...
      <div class="flex items-center gap-2 text-surface-500 font-mono">
        <Icon icon="mdi:copyright" width="16" />
        <span>{currentYear} Marco. All rights reserved.</span>
      </div>

      
      <div class="flex items-center gap-2 text-surface-500 font-mono text-xs">
        <span>Built with</span>
        <Icon icon="mdi:heart" width="14" class="text-primary-400 animate-pulse" />
        <span>& SvelteKit</span>
      </div>
