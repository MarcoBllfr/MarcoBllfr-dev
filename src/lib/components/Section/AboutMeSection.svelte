...
<section class="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
    ...
    <div class="space-y-6 lg:space-y-8 order-2 lg:order-1">
      ...
      <div class="flex flex-wrap items-center gap-3">
        ...
        >
          <Icon 
            icon={$language === 'it' ? 'twemoji:flag-italy' : 'twemoji:flag-united-kingdom'} 
            width="16"
          />
          <span>{$language}</span>
        </button>
        ...
        >
          ...
          <span class="hidden sm:inline">Switch to {$language === 'it' ? 'EN' : 'IT'}</span>
      ...
      <div>
        <span class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full
                     ...
                     text-sm font-bold">
          <Icon icon="mdi:checkbox-blank-circle" width="12" class="animate-pulse" />
          <span>ABOUT ME</span>
        </span>
      </div>
  ...
  <h1 class="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight text-primary-500 min-h-[1.2em]">
    {displayedText}<span class="animate-blink">|</span>
  </h1>
</div>

     
      <div class="prose-custom max-w-xl text-surface-300 leading-relaxed space-y-4">
        {@html aboutMe}
      </div>
    ...
    <div class="flex justify-center items-center order-1 lg:order-2 py-8 lg:py-0">
      <div class="relative">
        ...
        >
         ...
         <div class="relative">
          ...
          <div class="p-1 rounded-full bg-gradient-to-br from-primary-500 via-tertiary-500 to-secondary-500 shadow-2xl">
            <img
              src={image}
              alt="Marco"
          ...
          <div class="absolute -top-2 -right-2 sm:top-2 sm:right-2 lg:top-4 lg:right-4
            ...
            <div class="flex items-center gap-2">
              ...
              <span class="text-xs sm:text-sm font-semibold text-surface-200">UI/UX</span>
            </div>
          </div>

         
          <div class="absolute -bottom-2 -left-2 sm:bottom-2 sm:left-2 lg:bottom-4 lg:left-4
                      px-3 py-2 rounded-xl
                      bg-surface-900/70 backdrop-blur-md border border-surface-800
                      shadow-lg">
            <div class="flex items-center gap-2">
              ...
              <span class="text-xs sm:text-sm font-semibold text-surface-200 xs:hidden">React & Svelte</span>
            </div>
          </div>
        </div>
      </div>
